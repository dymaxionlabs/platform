...
import LayerSelector from "../quote/LayerSelector";
import SimpleModalContactForm from "../quote/SimpleModalContactForm";
...
const initialViewport = {
  ...
  center : [-32.865910530608107, -61.87674551818262],
  zoom: 15
};
...
const TileLayer = dynamic(() => import("../TileLayer"), {
  ssr: false
});
...
export default withNamespaces(["case_study", "case_study__agri"])(MapStep);
