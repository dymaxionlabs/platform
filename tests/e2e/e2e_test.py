...
def run_object_detection_e2e_test():
    ...
    artifacts_path = training_task.download_artifacts("vineyard/")
    print("Training artifacts downloaded at", artifacts_path)
    ...
    print("Prediction artifacts downloaded at", artifacts_path)
